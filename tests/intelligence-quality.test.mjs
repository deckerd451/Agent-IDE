...
const baseDocs = {
  'goals.md': '# Goals\n\n## Product Thesis\nAgent IDE creates local repository intelligence.\n\n## North Star Metric\nUseful handoffs\n\n## Current Focus\nQuality loop\n\n## Current Product Bet\nQuality loop\n\n## What Not To Build\nDo not add cloud calls.\n\n## Success Criteria\nUseful deterministic handoffs.\n\n## Long-Term Vision\nRepository intelligence guides local development.\n\n## Manual Goals\n- Product intent: Agent IDE creates local repository intelligence.\n- Current focus: Quality loop.\n- Success criteria: Useful deterministic handoffs.\n- Long-term vision: Repository intelligence guides local development.\n',
...
test('Nearify and Agent IDE retain expected quality scores after export generation', async () => {
  const nearifyDocs = {
    ...baseDocs,
    'goals.md': '# Goals\n\n## Product Thesis\nNearify helps people maintain real-world relationships through timely follow-up workflows.\n\n## North Star Metric\nMeaningful follow-ups\n\n## Current Focus\nEvent-aware relationship workflows\n\n## Current Product Bet\nEvent-aware relationship workflows\n\n## What Not To Build\nDo not add cloud calls.\n\n## Success Criteria\nMeaningful follow-ups improve.\n\n## Long-Term Vision\nRelationship workflows remain timely and useful.\n\n## Manual Goals\n- Product intent: Nearify helps people maintain real-world relationships through timely follow-up workflows.\n- Current focus: Event-aware relationship workflows.\n- Success criteria: Meaningful follow-ups improve.\n- Long-term vision: Relationship workflows remain timely and useful.\n',
    'strategy.md': '# Strategy\n\n## Product Thesis\nNearify helps people maintain real-world relationships through timely follow-up workflows.\n\n## North Star Metric\nMeaningful follow-ups\n\n## Current Product Bet\nEvent-aware relationship workflows\n\n## Strategy Confidence\nHigh\n\n## Evidence Sources\n- README.md\n',
