...
function renderRecommendationTrace({ stages, improvementCandidates, maintenanceIssues, allCandidates, decisionRanking, filesRead, docs }) {
  const lines = [];
...
export async function generateNextImprovement(repositoryPath = process.cwd(), options = {}) {
  ...
  const trace = renderRecommendationTrace({ stages, improvementCandidates, maintenanceIssues, allCandidates: candidates, decisionRanking, filesRead: requiredFiles, docs });
