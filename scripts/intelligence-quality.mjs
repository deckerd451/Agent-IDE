...
import { explainCompleteness, explainQuality, explainCompletenessSynchronization } from './intelligence-explanations.mjs';
...
export async function computeQualitySnapshot(repositoryPath, docs, previousQuality = null, previousHistory = []) {
  ...
  snapshot.explanations = { completeness: explainCompleteness(docs['goals.md'] ?? ''), quality: explainQuality(snapshot), completenessSynchronization: explainCompletenessSynchronization({ completeness: canonicalCompleteness }) };
